...
<!--            Modal que é aberto ao clicar novo usuario-->
            ...
            <div class="window" id="janela1">
                ...
                <form id="cadUsuario" action="" method="post">
                    <label>Nome:</label><input type="text" name="nomep" id="nome" />
                    <label>Email:</label><input type="text" name="emailp" id="email" />
                    <label>Senha:</label> <input type="text" name="senhap" id="senha" />
                    <br/><br/>
